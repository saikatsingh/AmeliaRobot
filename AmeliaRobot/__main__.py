...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/65393776d6ef725f0ac8d.jpg), ɪᴍ ɴᴀᴛᴀsʜᴀ ʀᴏᴍᴀɴᴏꜰꜰ ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` ɴᴀᴛᴀsʜᴀ ʀᴏᴍᴀɴᴏꜰꜰ [🙋‍♀️](https://telegra.ph/file/65393776d6ef725f0ac8d.jpg)
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

amelia_IMG = "https://telegra.ph/file/65393776d6ef725f0ac8d.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @AnnihilusOP\
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *ɴᴀᴛᴀsʜᴀ*, a powerful group management bot built to help you manage your group easily.
